        ...
        <div className=" p-14 flex flex-col gap-12">
            ...
            {state.loading.isLoading &&
                <div className="flex justify-center">
                    <div role="status">
                        <svg aria-hidden="true" className="w-16 h-16 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-[#3f51b5]" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
